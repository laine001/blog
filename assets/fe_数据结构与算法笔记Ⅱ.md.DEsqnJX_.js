import{_ as n,c as a,ad as l,o as p}from"./chunks/framework.CpiR5jpn.js";const F=JSON.parse('{"title":"队列数据结构","description":"","frontmatter":{"layout":"js","title":"队列数据结构","date":"2020-02-21T18:02:05.000Z","tags":"数据结构"},"headers":[],"relativePath":"fe/数据结构与算法笔记Ⅱ.md","filePath":"fe/数据结构与算法笔记Ⅱ.md","lastUpdated":1732006962000}'),o={name:"fe/数据结构与算法笔记Ⅱ.md"};function e(t,s,c,B,r,y){return p(),a("div",null,s[0]||(s[0]=[l(`<blockquote><p>栈数据结构是遵循先进先出原则的一组有序的项。最新添加的元素必须排在队列的末尾,例：排队</p></blockquote><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki one-dark-pro vp-code"><code><span class="line"><span style="color:#7F848E;font-style:italic;">/*</span></span>
...
<span class="line"><span style="color:#ABB2BF;">    }</span></span>
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre></div>`,2)]))}const A=n(o,[["render",e]]);export{F as __pageData,A as default};
