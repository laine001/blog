import{_ as a,D as n,o as i,c as p,I as l,R as e}from"./chunks/framework.ZRhsjope.js";const u=JSON.parse('{"title":"项目工具随手记","description":"","frontmatter":{},"headers":[],"relativePath":"daily/work-utils.md","filePath":"daily/work-utils.md"}'),t={name:"daily/work-utils.md"},h=e(`<h1 id="项目工具随手记" tabindex="-1">项目工具随手记 <a class="header-anchor" href="#项目工具随手记" aria-label="Permalink to &quot;项目工具随手记&quot;">​</a></h1><h2 id="获取路径中的参数" tabindex="-1">获取路径中的参数 <a class="header-anchor" href="#获取路径中的参数" aria-label="Permalink to &quot;获取路径中的参数&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>function getQuery(k) {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  })</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h2 id="生成指定范围的随机整数" tabindex="-1">生成指定范围的随机整数 <a class="header-anchor" href="#生成指定范围的随机整数" aria-label="Permalink to &quot;生成指定范围的随机整数&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// @param {Number} start 区间起点</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div>`,24);function k(r,c,d,o,E,g){const s=n("git-talk");return i(),p("div",null,[h,l(s)])}const F=a(t,[["render",k]]);export{u as __pageData,F as default};
