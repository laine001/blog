import{_ as s,c as n,o as a,a3 as l}from"./chunks/framework.BWtL4YFW.js";const _=JSON.parse('{"title":"队列数据结构","description":"","frontmatter":{"layout":"js","title":"队列数据结构","date":"2020-02-21T18:02:05.000Z","tags":"数据结构"},"headers":[],"relativePath":"fe/数据结构与算法笔记Ⅱ.md","filePath":"fe/数据结构与算法笔记Ⅱ.md","lastUpdated":1715864409000}'),p={name:"fe/数据结构与算法笔记Ⅱ.md"},o=l(`<blockquote><p>栈数据结构是遵循先进先出原则的一组有序的项。最新添加的元素必须排在队列的末尾,例：排队</p></blockquote><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki one-dark-pro vp-code"><code><span class="line"><span style="color:#7F848E;font-style:italic;">/*</span></span>
