import{_ as n,c as a,o as l,ad as p}from"./chunks/framework.C6Isdag-.js";const F=JSON.parse('{"title":"队列数据结构","description":"","frontmatter":{"layout":"js","title":"队列数据结构","date":"2020-02-21T18:02:05.000Z","tags":"数据结构"},"headers":[],"relativePath":"fe/数据结构与算法笔记Ⅱ.md","filePath":"fe/数据结构与算法笔记Ⅱ.md","lastUpdated":1739324305000}'),o={name:"fe/数据结构与算法笔记Ⅱ.md"};function e(t,s,c,B,r,y){return l(),a("div",null,s[0]||(s[0]=[p(`<blockquote><p>栈数据结构是遵循先进先出原则的一组有序的项。最新添加的元素必须排在队列的末尾,例：排队</p></blockquote><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki one-dark-pro vp-code"><code><span class="line"><span style="color:#7F848E;font-style:italic;">/*</span></span>
