import{_ as s,o as a,c as i,R as n}from"./chunks/framework.DO9dm5bS.js";const g=JSON.parse('{"title":"EventLoop","description":"","frontmatter":{"title":"EventLoop","date":"2019-09-10T22:04:35.000Z","categories":"javascript","type":"categories"},"headers":[],"relativePath":"daily/EventLoop.md","filePath":"daily/EventLoop.md"}'),p={name:"daily/EventLoop.md"},t=n(`<blockquote><p>javascript 事件循环机制</p></blockquote><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  // javascript 事件循环机制分为浏览器和node事件循环机制</span></span>
