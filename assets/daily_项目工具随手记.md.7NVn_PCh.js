...
<span class="line"><span>  }</span></span>
<span class="line"><span>};</span></span></code></pre></div><h2 id="将-object-拼接成-query-格式的-string" tabindex="-1">将 object 拼接成 query 格式的 string <a class="header-anchor" href="#将-object-拼接成-query-格式的-string" aria-label="Permalink to &quot;将 object 拼接成 query 格式的 string&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/**</span></span>
<span class="line"><span> * 将object拼接成query格式的string</span></span>
<span class="line"><span> * @param object</span></span>
<span class="line"><span> * @returns string param1=xxx&amp;param2=xxx</span></span>
<span class="line"><span> */</span></span>
<span class="line"><span>export const setUrlSearch = (objs = {}) =&gt; {</span></span>
<span class="line"><span>  const _rt: any = [];</span></span>
<span class="line"><span>  Object.keys(objs).forEach((key) =&gt; {</span></span>
<span class="line"><span>    const _val = objs[key];</span></span>
<span class="line"><span>    if (_val) {</span></span>
<span class="line"><span>      _rt.push(\`\${key}=\${typeof _val === &#39;object&#39; ? JSON.stringify(_val) : _val}\`);</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  });</span></span>
<span class="line"><span>  return _rt.join(&#39;&amp;&#39;);</span></span>
<span class="line"><span>};</span></span></code></pre></div>`,24),e=[l];function t(h,c,r,k,o,d){return a(),n("div",null,e)}const u=s(i,[["render",t]]);export{E as __pageData,u as default};
